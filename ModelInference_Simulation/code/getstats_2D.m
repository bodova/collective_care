%% line 16, 17 wrong max bound, now correct!
function[transitions,times,histY12] = Inference_get_statistics_trace2D(ant,var1,var2,events,durations,M,N1,y1,N2,y2,DTA,DTL,ifL);
global idty Lreset
